...
// SCREEN: ui_ScreenSettingESPNOW (Item 6 - ESP-NOW Audio)
void ui_ScreenSettingESPNOW_screen_init(void);
extern lv_obj_t *ui_ScreenSettingESPNOW;
extern lv_obj_t *ui_PanelScreenSettingESPNOWSwitch;
extern lv_obj_t *ui_ImagePanelScreenSettingESPNOWSwitch;
extern lv_obj_t *ui_LabelPanelScreenSettingESPNOWSwitch;
extern lv_obj_t *ui_SwitchPanelScreenSettingESPNOWSwitch;
extern lv_obj_t *ui_LabelScreenSettingESPNOWStatus;
extern lv_obj_t *ui_PanelScreenSettingESPNOWList;
extern lv_obj_t *ui_PanelScreenSettingESPNOWStats;
extern lv_obj_t *ui_LabelScreenSettingESPNOWPacketsRx;
extern lv_obj_t *ui_LabelScreenSettingESPNOWPacketsLost;
extern lv_obj_t *ui_LabelScreenSettingESPNOWRSSI;
extern lv_obj_t *ui_ButtonScreenSettingESPNOWDisconnect;
extern lv_obj_t *ui_SpinnerScreenSettingESPNOW;
void ui_event_ButtonScreenSettingESPNOWReturn(lv_event_t *e);
extern lv_obj_t *ui_ButtonScreenSettingESPNOWReturn;
extern lv_obj_t *ui_ImageScreenSettingESPNOWReturn;
void ui_event_SwitchScreenSettingESPNOW(lv_event_t *e);
void ui_event_ButtonScreenSettingESPNOWDisconnect(lv_event_t *e);

// Main screen Item 6 (ESP-NOW menu item)
void ui_event_PanelSettingMainContainerItem6(lv_event_t *e);
extern lv_obj_t *ui_PanelSettingMainContainerItem6;
extern lv_obj_t *ui_ImagePanelSettingMainContainer6ESPNOW;
extern lv_obj_t *ui_ImagePanelSettingMainContainer6Arrow;
extern lv_obj_t *ui_LabelPanelSettingMainContainer6ESPNOW;
