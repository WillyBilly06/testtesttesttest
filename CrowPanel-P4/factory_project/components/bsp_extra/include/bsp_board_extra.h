...
typedef enum {
	BSP_EXTRA_AUDIO_OUTPUT_SPEAKER = 0,
	BSP_EXTRA_AUDIO_OUTPUT_AUX = 1,
} bsp_extra_audio_output_route_t;
...
/**
 * @brief Select active audio output route.
 *
 * @param route Speaker codec output or AUX I2S output.
 *
 * @return
 *    - ESP_OK: Success
 *    - Others: Fail
...
/**
 * @brief Get active audio output route.
 */
